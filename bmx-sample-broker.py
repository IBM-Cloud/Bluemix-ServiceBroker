...
#
# In the related tutorial we show how to use this broker with IBM Bluemix
# and how to register and manage this broker in different ways.
# The code is kept as simple as possible (from my view...).
#
